            ...
            <jsp:include page="header/header-bottom1.jsp"></jsp:include>
                ...
                <div classname="body">
                    <div style="background-color: whitesmoke">
                        ...
                        <!--thêm nút sort ở đây-->
                        <!--item list-->
                        <h2 class="text-2xl font-bold tracking-tight text-gray-900">All Jacket</h2>                         
                        ...
                        <%
                            ...
                            int pageSize = 8;
                            List<Product> products = productDAO.getProductPage(pageNumber, pageSize);
                    ...
                    <%
                        ...
                        int totalRecords = productDAO.getTotalRow("M") + productDAO.getTotalRow("U") + productDAO.getTotalRow("W"); // The total number of products (assuming 100 in this example)
