            ...
            <jsp:include page="header/header-bottom1.jsp"></jsp:include>
                ...
                <div classname="body">
                    <div style="background-color: whitesmoke">
                        ...
                        <!--item list-->
                        <h2 class="text-2xl font-bold tracking-tight text-gray-900">Featured jackets</h2>                         
                        ...
                        <%
                          ...
                          int pageNumber = 1;
                            ...
                            int pageSize = 8;
                            List<Product> products = productDAO.getProductPageFeature(pageNumber, pageSize);
                    ...
                    <%
                        ...
                        int totalRecords = 12; // The total number of products (assuming 100 in this example)
